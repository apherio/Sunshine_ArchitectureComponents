...
import com.apherio.sunshine.BR;
class DataBinderMapperImpl extends android.databinding.DataBinderMapper {
    ...
    public android.databinding.ViewDataBinding getDataBinder(android.databinding.DataBindingComponent bindingComponent, android.view.View view, int layoutId) {
        switch(layoutId) {
                case com.apherio.sunshine.R.layout.activity_detail:
 {
                        final Object tag = view.getTag();
                        if(tag == null) throw new java.lang.RuntimeException("view must have a tag");
                    if ("layout-land/activity_detail_0".equals(tag)) {
                            return new com.apherio.sunshine.databinding.ActivityDetailBindingLandImpl(bindingComponent, view);
                    }
                    if ("layout/activity_detail_0".equals(tag)) {
                            return new com.apherio.sunshine.databinding.ActivityDetailBindingImpl(bindingComponent, view);
                    }
                        throw new java.lang.IllegalArgumentException("The tag for activity_detail is invalid. Received: " + tag);
                }
                case com.apherio.sunshine.R.layout.primary_weather_info:
 {
                        final Object tag = view.getTag();
                        if(tag == null) throw new java.lang.RuntimeException("view must have a tag");
                    if ("layout/primary_weather_info_0".equals(tag)) {
                            return new com.apherio.sunshine.databinding.PrimaryWeatherInfoBinding(bindingComponent, view);
                    }
                        throw new java.lang.IllegalArgumentException("The tag for primary_weather_info is invalid. Received: " + tag);
                }
                case com.apherio.sunshine.R.layout.extra_weather_details:
 {
                        final Object tag = view.getTag();
                        if(tag == null) throw new java.lang.RuntimeException("view must have a tag");
                    if ("layout/extra_weather_details_0".equals(tag)) {
                            return new com.apherio.sunshine.databinding.ExtraWeatherDetailsBinding(bindingComponent, view);
                    }
        ...
        switch(code) {
            case 597830097: {
                if(tag.equals("layout-land/activity_detail_0")) {
                    return com.apherio.sunshine.R.layout.activity_detail;
                }
                break;
            }
            case 257710925: {
            ...
            case 98450412: {
                if(tag.equals("layout/primary_weather_info_0")) {
                    return com.apherio.sunshine.R.layout.primary_weather_info;
                }
                break;
            }
            case -19416940: {
                if(tag.equals("layout/extra_weather_details_0")) {
                    return com.apherio.sunshine.R.layout.extra_weather_details;
                }
                break;
            }
        }
