...
public class ActivityDetailBindingLandImpl extends ActivityDetailBinding  {
    ...
    private ActivityDetailBindingLandImpl(android.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 2
            , (com.apherio.sunshine.databinding.ExtraWeatherDetailsBinding) bindings[2]
            , (com.apherio.sunshine.databinding.PrimaryWeatherInfoBinding) bindings[1]
            );
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            case 0 :
                return onChangePrimaryInfo((com.apherio.sunshine.databinding.PrimaryWeatherInfoBinding) object, fieldId);
            case 1 :
                return onChangeExtraDetails((com.apherio.sunshine.databinding.ExtraWeatherDetailsBinding) object, fieldId);
        }
        return false;
    }
    private boolean onChangePrimaryInfo(com.apherio.sunshine.databinding.PrimaryWeatherInfoBinding PrimaryInfo, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x1L;
            }
    ...
    private boolean onChangeExtraDetails(com.apherio.sunshine.databinding.ExtraWeatherDetailsBinding ExtraDetails, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x2L;
            }
